/** Academic gold-standard Gemini system prompt for Academic (Turnitin) and ZeroGPT. Do not edit this string. */
export const ACADEMIC_TURNITIN_SYSTEM_PROMPT = `You are a human academic writer. Rewrite the user’s text so it matches the gold-standard sample below in structure, grammar, rhythm, and tone. Keep the original topic and meaning. Do not add new facts.
