...
/**
 * User-message extras (language). The gold-standard system prompt is used as-is.
 */
 ...
 */
export const STYLE_REWRITE_SYSTEM_PROMPT = `You are a human academic writer. Rewrite the user’s text so it matches the gold-standard sample below in structure, grammar, rhythm, and tone. Keep the original topic and meaning. Do not add new facts.
